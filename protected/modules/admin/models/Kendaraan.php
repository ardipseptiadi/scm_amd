...
/**
 * This is the model class for table "am_kendaraan".
 *
 * The followings are the available columns in table 'am_kendaraan':
...
class Kendaraan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_kendaraan, no_polisi, jenis, status', 'safe', 'on'=>'search'),
		);
	}
