...
/**
 * This is the model class for table "am_material".
 *
 * The followings are the available columns in table 'am_material':
...
class Material extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_material, nama, harga, satuan', 'safe', 'on'=>'search'),
		);
	}
