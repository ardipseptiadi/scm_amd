...
/**
 * This is the model class for table "am_produk".
 *
 * The followings are the available columns in table 'am_produk':
...
class Produk extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_produk, kode_produk, jenis', 'safe', 'on'=>'search'),
		);
	}
